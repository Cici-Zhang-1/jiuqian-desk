	  		...
	  		<div class="col-md-offset-3 col-md-6 text-right" id="cardFunction">
				<div class="btn-group" role="group">
					...
					<ul class="dropdown-menu" role="menu" data-table="#cardTable">
						<li><a id="cardEdit" href="javascript:void(0);" data-toggle="modal" data-target="#cardModal" data-action="<?php echo site_url('priviledge/card/edit');?>" data-multiple=false><i class="fa fa-pencil"></i>&nbsp;&nbsp;编辑</a></li>
						<li role="separator" class="divider"></li>
						<li><a href="javascript:void(0);" data-toggle="child" data-target="#cardTable" data-action="<?php echo site_url('priviledge/element/index/read');?>" data-multiple=false><i class="fa fa-eye"></i>&nbsp;&nbsp;元素</a></li>
					</ul>
				</div>
				<button class="btn btn-primary" type="button" value="新增" data-toggle="modal" data-target="#cardModal" data-action="<?php echo site_url('priviledge/card/add');?>"><i class="fa fa-plus"></i>&nbsp;&nbsp;新增</button>
				<button class="btn btn-default" data-toggle="refresh" type="button" value="刷新"><i class="fa fa-refresh"></i>&nbsp;&nbsp;刷新</button>
				<a class="btn btn-default" data-toggle="backstage" data-target="#cardTable" href="<?php echo site_url('priviledge/card/remove');?>" data-multiple=true><i class="fa fa-trash-o"></i>&nbsp;&nbsp;删除</a>
