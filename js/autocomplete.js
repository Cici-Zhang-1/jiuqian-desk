...
;(function($){
    ...
    var _calcZindex = function(){
    	if(typeof(this.option.z_index) === 'string' && this.option.z_index.toLowerCase() === 'auto'){
    		return 'auto';
    	}else if(typeof(this.option.z_index) === 'number'){
    		return this.option.z_index;
    	}else{
    		throw '遇到未知的z_index参数！';
    	}
    }
    ...
    var _showSearchView = function(result){
        ...
        try{
            ...
            this.searchView.css("z-index", _calcZindex.apply(this));
