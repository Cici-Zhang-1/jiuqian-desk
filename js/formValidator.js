...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		if(/msie/.test(navigator.userAgent.toLowerCase()).msie)
		{
	...
	ajaxForm : function(validatorGroup,option,formid)
	{
		...
		switch(setting.type.toLowerCase()){
			case 'post':
				setting.data = typeof(setting.data) == 'undefined'? parm: setting.data+'&'+parm;
				break;
			case 'get':
...
var regexEnum = 
{
	...
	chinese:"^[\\u4E00-\\u9FA5\\uF900-\\uFA2D]+$",					//仅中文^[\u4E00-\u9FA5\uF900-\uFA2D\\w\\d]{1,32}$
	ascii:"^[\\x00-\\xFF]+$",				//仅ACSII字符
	zipcode:"^\\d{6}$",						//邮编
	mobile:"^13[0-9]{9}|15[012356789][0-9]{8}|18[0-9]{9}|147[0-9]{8}|17[0-9]{9}$",				//手机
	...
	usernames:"^[\\u4E00-\\u9FA5\\uF900-\\uFA2D\\w\\s]+$",  //用来用户注册。匹配由数字、26个英文字母或者下划线以及空格组成的字符串
	letter:"^[A-Za-z]+$",					//字母
	letter_u:"^[A-Z]+$",					//大写字母
	letter_l:"^[a-z]+$",					//小写字母
	idcard:"^[1-9]([0-9]{14}|[0-9]{17})$",	//身份证
	character: "^[\\u4E00-\\u9FA5\\uF900-\\uFA2D\\x00-\\xFF]+$", //中文、ASSIC
}
...
(function($){
	...
	var _emptypInputView = function(){
		if($.trim(this.inputView.val()) == ''){
		}
	}
